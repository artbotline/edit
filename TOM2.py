...
cl = LINETCR.LINE() 
cl.login(token="EpOKFU5kfEMsE8uPkWS4.4njzDnCKlLBeMThs5Bey5a.pk+42DVcKMot8FBXf5XxI6LK9tcHpDosAOag3ONq6nU=")
...
║      •─✯͜͡ ✯TOM★BOTLINE✯͜͡ ✯─•
╠══════════════════
╠http//:line.me/ti/p/~siriv10bytom
╚══════════════════ 
"""
helpMessage2 ="""╔══════════════════
║       ✦คำสั่งใช้ลบรัน✦
...
wait = {
    ...
    "pname":{},
    "pro_name":{},
    "tag1":"แท็คขนาดนี้ มาปี้กันไหม ?",
    "tag2":"แท็คไม่หยุดเดะฉุดไปข่มขืน",
    "posts":False,
    }
...
#======================================================#
            ...
            elif msg.text in ["ต้อม","ตาต้อม","พี่ต้อม"]:
                        cl.sdndText(msg.to," มีอะไรครับ ตาต้อมเลิกขายบอทละครับผม")
