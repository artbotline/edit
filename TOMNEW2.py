...
cl = LINETCR.LINE()
cl.login(token="Epy2i43is06Sv0Ee6mZe./YLQOgIZ+sj+8fIgzRvH+G.ArcZBXEfHJSwjPlFV9ap3uPzuRuJzIcJXJH7EXhFNZ0=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="EpC6u2ndzuaamNTtarg4.aQwlG1Yb79ZynULT8qCRja.X1QfrVSuwP+1ytymK6c/PA2ewWwVr/SMeGl7x3g4VUI=")
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EpTU2VzwUeqSReE3wFE8.ghZnmC2ciegQIghsMM2+ka.v/Z7DC+JeqKDQH3gtYFt2fRFUQ17RIQJCeQEgDKYuuI=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="Ep5hXHEYVFMckuqdtS8e.VaiImiEjGvzw9+FPEujUpG.AGOP1ScYsdF7R27UgTQxEjlWQzGH3mki6Rf4HnbeuYw=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EpyDNPrHjUm7ijrrVCSf.ErORVM2uZkxL3DKI0dXZpW.tA1Ki0RhI9YToaHoqi3KFGO9RTW/3KAvRu6CbxastXA=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Ep0tiSM2Ryv15LCAJno7.7xZurXNCqndHG6OfwUrtzW.83Nk+j5KXWP9TtNjuimEPqoGnFPfX+NCgRCo/OtEHhM=")
ki5.loginResult()

#ki6 = LINETCR.LINE()
#ki6.login(token="EprPwEomy6Pk9lEoPJ26.alc3n8osAFS/h7CZtZCrzG.KuzZ8ZRU/Yf+77tItlpmxHE/QQQoLyTVm9+hKkqrn4U=")
#ki6.loginResult()

#ki7 = LINETCR.LINE()
#ki7.login(token="EpI9nH8E9g0hhcbA6Y19.piEBKUd2sZktycBTxI26Eq.gZ+QUyxp/SctWQCQVa1Nd04Sytq5VpBS23VBR4jIVYQ=")
#ki7.loginResult()

#ki8 = LINETCR.LINE()
#ki8.login(token="Ep5Lt404GtMCdKkeaz37.Ux56qct9JYv2DvqGYyyAzW./9ZIk7nr61wA4XBNXgdVokSIDsd9kv5ExrEpxPAkrwQ=")
#ki8.loginResult()

#ki9 = LINETCR.LINE()
#ki9.login(token="EpcvQUPpLLHCtHgofb59.35X+i5qijuVYXGrw7KE7sq.H1eAjP3R1Ds0V3RJ3nz8hqomcxuwF94a2sTxw2cU4Qw=")
#ki9.loginResult()

#ki10 = LINETCR.LINE()
#ki10.login(token="EpQf8lYTOmHuIwwdnfD9.zun8h7rPPDCccXPYYHXDIq.MulYfHbPV+6AYuIdQASVKsGlwra3IeYU+TgYCB9fxS8=")
#ki10.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["ufb296aa068b3fd227ff0588666b561fe",mid,Amid1,Amid2,Amid3,Amid4,Amid5]
self = ["ufb296aa068b3fd227ff0588666b561fe",mid,Amid1,Amid2,Amid3,Amid4,Amid5]
admin = "ufb296aa068b3fd227ff0588666b561fe"
admsa = "ufb296aa068b3fd227ff0588666b561fe"
owner = "ufb296aa068b3fd227ff0588666b561fe"
adminMID = "ufb296aa068b3fd227ff0588666b561fe"
Creator="ufb296aa068b3fd227ff0588666b561fe"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add Me MY NAME IS Tome BotLine Thailand\n http://line.me/ti/p_hhRkiw2jP",
    "lang":"JP",
                ...
                if Amid3 in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("client が蹴り規制orグループに存在しない���、\n["+op.param1+"]\nの\n["+op.param2+"]\nBecause the client does not exist in the kick regulation or group.\nAdd it to the blacklist.")
                        if op.param2 in wait["blacklist"]:
                            pass
                        if op.param2 in wait["whitelist"]:
                            pass
                ...
                #        ki8.acceptGroupInvitationByTicket(msg.to,Ticket)
                 #       ki9.acceptGroupInvitationByTicket(msg.to,Ticket)
                  #      ki10.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ...
                        ki1.sendText(msg.to,"[SELFBOT BT TOMEBOTLINE]")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki3.sendText(msg.to,"[☢ŦOME BOTLINE☢]")
...
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
Siri:groupcreator เช็คเจ้าของบ้าน���ัวจริง
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
...
#-----------------------------------------------
            ...
            elif msg.text in ["Cl cancelgroup"]:
                gid = cl.getGroupIdsInvited()
                for i in gid:
                    cl.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
            ...
            elif msg.text in ["Ki cancelgroup"]:
                gid = ki.getGroupIdsInvited()
                for i in gid:
                    ki.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
            ...
            elif msg.text in ["Ki2 cancelgroup"]:
            ...
            elif msg.text in ["Ki3 cancelgroup"]:
            ...
            elif msg.text in ["Ki4 cancelgroup"]:
            ...
            elif msg.text in ["Ki5 cancelgroup"]:
...
#            elif msg.text in ["Ki6 cancelgroup"]:
     ...
     #              ki6.sendText(msg.to,"ลบห้องเชิญเรียบร้อยแล้ว")
      #          else:
       #             ki6.sendText(msg.to,"He declined all invitations")
        #    elif msg.text in ["Ki7 cancelgroup"]:
         #       gid = ki7.getGroupIdsInvited()
          #      for i in gid:
           #         ki7.rejectGroupInvitation(i)
            #    if wait["lang"] == "JP":
             #       ki7.sendText(msg.to,"ลบห้องเชิญเรียบร้อยแล้ว")
              #  else:
               #     ki7.sendText(msg.to,"He declined all invitations")
#            elif msg.text in ["Ki8 cancelgroup"]:
 #               gid = ki8.getGroupIdsInvited()
  #              for i in gid:
   #                 ki8.rejectGroupInvitation(i)
    #            if wait["lang"] == "JP":
     #               ki8.sendText(msg.to,"ลบห้องเชิญเรียบร้อยแล้ว")
      #          else:
       #             ki8.sendText(msg.to,"He declined all invitations")
        #    elif msg.text in ["Ki9 cancelgroup"]:
         #       gid = ki9.getGroupIdsInvited()
          #      for i in gid:
           #         ki9.rejectGroupInvitation(i)
            #    if wait["lang"] == "JP":
             #       ki9.sendText(msg.to,"ลบห้องเชิญเรียบร้อยแล้ว")
              #  else:
               #     ki9.sendText(msg.to,"He declined all invitations")
#            elif msg.text in ["Ki10 cancelgroup"]:
 #               gid = ki10.getGroupIdsInvited()
  #              for i in gid:
   #                 ki10.rejectGroupInvitation(i)
    #            if wait["lang"] == "JP":
     #               ki10.sendText(msg.to,"ลบห้องเชิญเรียบร้อยแล้ว")
      #          else:
       #             ki10.sendText(msg.to,"He declined all invitations")

            elif msg.text in ["Group cancelall","ลบรันทั้งหมด"]:
                gid = cl.getGroupIdsInvited()
                for i in gid:
                    cl.rejectGroupInvitation(i)
                gid = ki.getGroupIdsInvited()
...
#-------------------------------------------------
            ...
            elif msg.text in ["Tome all off","Tome all off"]:
                        cl.sendText(msg.to,"─┅══ईह ㏒ Ᵽɧëȶ ㏒ ईह══┅─\n\n[SELF BOT PHET HACK BOT]")
                        cl.sendText(msg.to,"Please wait......")
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["เรียก"]:
                ...
                cl.sendMessage(cnt)
                        ...
                        cl.sendText(msg.to,"เอ้อ ...มึงนั้นแหล่ะเช๊คไรนักหนา")
            elif ".11" == msg.text.lower():
                if msg.to in wait2['readPoint']:
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
