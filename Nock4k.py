...
cl = LINETCR.LINE() 
cl.login(token="EpGQ2UNeEg6GDtj24DZe.lSFWf+CIM21hxoHnODC4lG.UHDVhxXy/Tm5fdOvyUn/YoHRQxukDKzKhK89KsdCMis=")
print "cl login success"

ki = LINETCR.LINE() 
ki.login(token="Epqs0fTzPEVd4hOETtw7.eL2MWqIn7IuSXmWCU3t8DW.m/WdFLxF0jIiHuqKJ79Bq3zOGyl3WWa4E6pWAy3HNzE=")
print "ki login success"

kk = LINETCR.LINE() 
kk.login(token="EpxbPXu8Vs4vJf8gVnl9.00NQR/oqIl27oe0C/MW4Qq.mybn50ofh0SkwUxGpNfIuSLdfCq9Yvpfr6EajXlenbY=")
print "ki2 login success"

kc = LINETCR.LINE() 
kc.login(token="EphIBtGc5SlF9URVDV9f.RCo8nstHIvpuXPUSm6gBVW.fPL7AE6dp1V/V7hwB6qUnh1vd98meyqbv6Onb/HzTkM=")
print "ki3 login success"

ks = LINETCR.LINE() 
ks.login(token="EpDA2APAblnBFBA8Ylte.H6PUuhAVz9kS23CLgJgZdG.1zq7B+ItF7OPO5uh9cxw/qsTxPJuguQOlBE+YD7KUxw=")
...
admin = ["u2ec7f017f7229b6d475ce84da1d7382e"]
owner = ["u2ec7f017f7229b6d475ce84da1d7382e"]
self = ["u2ec7f017f7229b6d475ce84da1d7382e"]
Creator = ["u2ec7f017f7229b6d475ce84da1d7382e"]
...
#=======================================================
              ...
              if msg.from_ in admin:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u2ec7f017f7229b6d475ce84da1d7382e',"}
                cl.sendMessage(msg)
#-----------------=============================   
            elif msg.text in ["Me"]:
	      if msg.from_ in admin:
...
#==================================================================
              ...
              if msg.from_ in admin:
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'ue0d25974d7242e56c49ad1d2e5b118e4'}
                cl.sendMessage(msg)
